...
class OpponentBehavior:
    ...
    def draw_to_screen(self):
        self.opponent_rect = pygame.rect.Rect(self.opponent_x, OpponentBehavior.opponent_y, self.opponent_width,
    ...
    def move_opponent(self):
        if BallBehavior.ball_x > self.screen.get_width() / 2:
            if BallBehavior.ball_y > OpponentBehavior.opponent_y:
                ...
                if BallBehavior.ball_x > self.screen.get_width() * .8 and abs(
                        BallBehavior.ball_y - OpponentBehavior.opponent_y) > self.screen.get_height() * .05:
                    OpponentBehavior.opponent_y += BallBehavior.opponent_speed * 1.75
